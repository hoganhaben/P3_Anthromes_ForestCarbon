...
```{r}
anova1 <- aov(beta ~  anthromes2023_3CL * global_region, data = beta_feedback)
summary(anova1)
```
## beta feedback - temperate & boreal
```{r}
mod1a <- aov(beta ~ anthromes2023_3CL, data = beta_feedback[beta_feedback$global_region == "temperate & boreal",])
...
mod1b <- aov(beta ~ anthromes2023_3CL, data = beta_feedback[beta_feedback$global_region == "tropical",])
...
```{r}
anova2 <- aov(gamma ~ anthromes2023_3CL * global_region, data = gamma_feedback)

summary(anova2)
```
## beta feedback - temperate & boreal
```{r}
mod2a <- aov(gamma ~ anthromes2023_3CL, data = gamma_feedback[gamma_feedback$global_region == "temperate & boreal",])
...
## beta feedback - tropical
```{r}
mod2b <- aov(gamma ~ anthromes2023_3CL, data = gamma_feedback[gamma_feedback$global_region == "tropical",])
